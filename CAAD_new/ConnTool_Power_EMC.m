...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ImageTemplate = '[Exp]/Subjects/ABIDEII-EMC_1/[Subject]/session_1/[Run]/ICA_AROMA';
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
confoundFile = 'unsmoothed_denoised_func_data_nonaggr'; %unsmoothed data after AROMA Denoise.sh
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
connectFile  = 'denoised_func_data_nonaggr'; %smoothed output image from AROMA
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
AnatomyMaskPath = '[Exp]/Subjects/ABIDEII-EMC_1/[Subject]/session_1/coReg';

GreyFile  = '';
WhiteFile = 'WM_mask.nii';
CSFFile   = 'CSF_mask.nii';
...
EPIBrainMaskTemplate = ...
    '/net/parasite/SchizConnect/ROIs/rs_spm12_mni_icbm152_nlin_sym_09b_1xero_s8_thrp35_mask.nii';
...
RealignmentParametersTemplate = ...
    '[Exp]/Subjects/ABIDEII-EMC_1/[Subject]/session_1/[Run]/rp_trest.txt';
...
CensorParametersTemplate = ...
    '[Exp]/MotionSummary/CensorVectors/EMC/CensorVector_[Subject].mat';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ROICenters = [0 -48 26];
ROIfile = '/net/pepper/Penn/ROIS/DossenbachROIS_FromPower2011.csv';
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ROITemplate = '[Exp]/ShenParcellation/resampled_ParcellatedImages';
ROIImages = {
    };
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputTemplate  = '[Exp]/FirstLevel/ConnTool/EMC/[Subject]/[OutputName]/';
OutputName      = 'Power';
